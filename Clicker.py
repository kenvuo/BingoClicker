...
class Recorder:
    ...
    def __init__(self):
        ...
        self.clickerP = multiprocessing.Process(target=self.listen)
        self.clickerP.daemon = True
    ...
    def OnKeyboardEvent(self, event):
        ...
        if ctrl_pressed and pyHook.HookConstants.IDToName(event.KeyID) == 'D':
            print("ctrl+D pressed")
            # Setting up recorder threads
            # Try start clicker
            self.clickerP.start()

        if pyHook.HookConstants.IDToName(event.KeyID) == 'Return':
            print('return pressed')
            self.clickerP.terminate()
...
class KeystrokeWatcher:
    ...
    def __init__(self):
        ...
        # set up recorder and clicker
        #a = Recorder()
        #self.clickerP = multiprocessing.Process(target=a.record)
        #self.clickerP.daemon = True
